 ...
 * <li>See {@link Factory} for supported channel manager factory configuration keys and defaults.</li>
 * </ul>
 */
public abstract class ChannelManager implements AutoCloseable {
    ...
    /**
     * Factory for building {@link ChannelManager ChannelManagers}.
     * <p>
     * Configuration Keys:
     * <ul>
     * <li>{@code GRPC_CHANNEL_MANAGER_CLASS_NAME} - Subclass name used to initialize the appropriate
     * {@link ChannelManager} type</li>
     * </ul>
     */
    public static class Factory {
        public static final String MANAGER_CLASS_NAME = GRPC_CHANNEL_PREFIX + "MANAGER_CLASS_NAME";

        private final Constructor<? extends ChannelManager> constructor;
        private final Configurator configG;
        private final ChannelValidator validator;

        public Factory(Configurator configG, ChannelValidator validator) {
            this.constructor = getConstructor(configG);
            this.configG = configG;
            this.validator = validator;
        }

        private static Constructor<? extends ChannelManager> getConstructor(Configurator configG) {
            String className = configG.findStringEntry(MANAGER_CLASS_NAME, PooledChannelManager.class.getName());
            try {
